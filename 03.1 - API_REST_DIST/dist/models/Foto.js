 ...
 class Foto extends _sequelize.Model {
  static init(sequelize) {
    super.init({
      ...
      sequelize,
      tableName: 'fotos', // so para exemplo, eu posso passar o nome da tabela no segundo argumento, casa o nome da classe seja diferente do nome da tabela no banco de dados
    });
    return this;
  }
